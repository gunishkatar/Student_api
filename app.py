...
from bson import json_util #humme binary data bhi dalne deta h
#jsonify is equal to json.dumps
MONGODB_URI = "mongodb://test:test@ds029207.mlab.com:29207/student_record"
...
def student_list():
	if request.method == 'GET':
		...
		return json_util.dumps(students), 200 # 200 means ok
